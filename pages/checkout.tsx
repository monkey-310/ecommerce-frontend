      ...
      <Card.Body>
        <div>
          {cartItems.length > 0 ? (
            ...
            <>
              <Text color='error'>No Product</Text>
              <Spacer y={1} />
            </>
          )}
        </div>
        ...
        <div>
          ...
          <Row css={{ mb: 5 }} justify='space-between'>
            <Text css={{ color: '$accents9' }}>Total:</Text>
            <Text css={{ color: '$accents9' }}>
              {totalPrice(cartItems)?.toLocaleString('en-US')} $
            </Text>
          </Row>
          <Row css={{ mb: 5 }} justify='space-between'>
            <Text css={{ color: '$accents9' }}>Shipping fee:</Text>
            <Text css={{ color: '$accents9' }}>{shipCost} D</Text>
          </Row>
          <Row css={{ mb: 5 }} justify='space-between'>
            <Text css={{ color: '$accents9' }}>Reduce:</Text>
            <Text css={{ color: '$accents9' }}>{discount} D</Text>
          </Row>
          <Spacer y={1} />
          <Card.Divider />
          <Spacer y={1} />
