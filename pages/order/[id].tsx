        ...
        <Container xs>
          ...
          <Card>
            ...
            <Card.Body css={{ padding: 20 }}>
              ...
              <Text size='$xl' css={{ mb: 5 }}>
                Receiver: <Text b>{order?.fullName}</Text>
              </Text>
              <Text size='$xl' css={{ mb: 5 }}>
                Phone number: <Text b>{order?.phone}</Text>
              </Text>
              <Text size='$xl' css={{ mb: 5 }}>
                Delivered to: <Text b>{order?.address}</Text>
              </Text>
              <Text size='$xl' css={{ mb: 5 }}>
                Payment method: <Text b>{order?.paymentMethod}</Text>
              </Text>
              <Text size='$xl' css={{ mb: 5 }}>
                Pay Status:{' '}
                <Text b>
              ...
              <Text size='$xl' css={{ mb: 5 }}>
                Shipping Fee:{' '}
                <Text b>{order?.shippingCost.toLocaleString('en-US')} $</Text>
              </Text>
              <Text size='$xl' css={{ mb: 5 }}>
                Total Amount:{' '}
          ...
          <Collapse.Group css={{ padding: 0, mt: 50 }}>
            <Collapse shadow title='Information order'>
                  ...
                  {order?.orderItems.map((o) => (
                    <tr key={o.id}>
                      ...
                      <td>
                        {' '}
                        <Text css={{ textAlign: 'center' }}>
                          {o.orderedPrice.toLocaleString('en-US')} $
                        </Text>
                      </td>
                    </tr>
                  ))}
