                  ...
                  <a style={{ width: '100%' }}>
                    <Card variant='bordered' isHoverable>
                      ...
                      <Card.Body css={{ py: isMobile ? '$6' : '$10' }}>
                        ...
                        >
                          {i.variants[0].price.toLocaleString('en-US')} $
                        </Text>
                      </Card.Body>
                    </Card>
                  </a>
...
const ProductNew = () => {
  ...
  return <ItemsList title='Product New' data={productNew?.items} />;
};

const ProductPopular = () => {
  const { data: productPopular } = useProducts('/popular?limit=8');
  return <ItemsList title='Product Outstanding' data={productPopular?.items} />;
};
